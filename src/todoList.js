    ...
    <div>
        ...
        <div className="todo-filter">
          <div className="left">
            ...
            <div className="right">
                <ul>
                    <li className='actived' id="filterBtnAll"> <span onClick={() => this.todoListFilter('All')}> All </span> </li>
                    <li className='stayed' id="filterBtnActive"> <span onClick={() => this.todoListFilter('Active')}> Active </span> </li>
                    <li className='finished' id="filterBtnCompleted"> <span onClick={() => this.todoListFilter('Completed')}> Completed </span> </li>
                </ul>
            </div>
        </div>
    </div>
